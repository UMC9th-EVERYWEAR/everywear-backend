...
public class ReviewController {
    ...
    @Operation(
            summary = "특정 상품의 AI 리뷰 생성",
            description = "특정 상품의 모든 리뷰를 ChatGPT로 요약하여 AI 리뷰를 생성합니다."
    )
    ...
    public ApiResponse<Map<String, Object>> generateAiReview(
        ...
        String aiReview = reviewCommandService.generateAiReview(productId);

        Map<String, Object> result = new HashMap<>();
        result.put("productId", productId);
        result.put("aiReview", aiReview);
        result.put("message", "AI 리뷰가 성공적으로 생성되었습니다.");
